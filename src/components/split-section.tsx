...
export const SplitSection = (props: SplitSectionUI) => (
  <div className={`row flex-column-reverse ${props.direction === 'image-left' ? 'flex-md-row-reverse' : 'flex-md-row'}`}>
    <div className="col-md-6">
      ...
      <p className="lead font-weight-normal text-secondary">{props.textContent}</p>
    </div>
    ...
    <div className={`col-md-6 d-flex ${props.direction === 'image-right' ? 'justify-content-md-end' : 'justify-content-md-start'}`}>
      {props.imgUrl.length === 0 ? (
        <svg className="bd-placeholder-img rounded float-left" width="300" height="300" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 300x300"><title>Placeholder</title><rect width="100%" height="100%" fill="#868e96"></rect><text x="40%" y="50%" fill="#dee2e6" dy=".3em">200x200</text></svg>
      ) : (
